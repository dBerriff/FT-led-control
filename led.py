...
async def main():
    ...
    led_channel.set_on_pc(1)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(2)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(4)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(8)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(16)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(32)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
    led_channel.set_on_pc(64)
    print(led_channel._dc_16)
    await asyncio.sleep(2)
