...
async def main():
    ...
    while True:
        ...
        await display_string(npg, 'Nain and Taid', rgb, level)
        npg.clear()
        gc.collect()
        await asyncio.sleep_ms(1000)
        await display_string(npg, 'Ceri and Lisa', rgb, level)
        npg.clear()
        gc.collect()
        await asyncio.sleep_ms(1000)
        await display_string(npg, 'Elaine, Ffinlo and Harry', rgb, level)
        npg.clear()
        gc.collect()
        await asyncio.sleep_ms(1000)
